  ...
  return (
    <div className="min-h-screen w-full bg-[#02050e] p-4 font-sans text-slate-100 selection:bg-indigo-500/30 md:p-8">
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        {/* ================= 3. LAYOUT PRINCIPAL (SIMETRIA PERFEITA) ================= */}
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-12 items-stretch">
          ...
          <div className="space-y-6 lg:col-span-8 flex flex-col justify-between">
            ...
            {/* CARD 4: Minhas Matérias (ALTURA FIXA E SCROLL SUAVE) */}
            <div className="space-y-4 rounded-3xl border border-white/10 bg-linear-to-br from-[#090d16] to-[#05070e] p-6 shadow-2xl backdrop-blur-2xl h-[320px] flex flex-col">
              ...
              {isLoading ? (
                ...
                <div className="my-auto rounded-2xl border border-white/5 bg-slate-950/40 py-8 text-center">
                  <p className="text-xs text-slate-400">
          ...
          <div className="space-y-6 lg:col-span-4 flex flex-col justify-between">
            ...
            {/* WIDGET 4: PAINEL RÁPIDO DE DESEMPENHO (EQUILIBRA A ALTURA COM A ESQUERDA) */}
            <div className="rounded-3xl border border-white/10 bg-linear-to-br from-[#090d16] to-[#05070e] p-5 shadow-2xl backdrop-blur-2xl">
              <div className="flex items-center justify-between text-xs font-bold uppercase tracking-wider text-slate-300">
                <span className="flex items-center gap-2">
                  <Clock size={14} className="text-indigo-400" />
                  Ritmo Diário
                </span>
                <span className="font-mono text-[10px] text-indigo-400">Hoje</span>
              </div>
