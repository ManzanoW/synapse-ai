  ...
  return (
    <div className="min-h-screen bg-[#030712] text-slate-100 p-3.5 sm:p-6 font-sans antialiased relative">
      <div className="max-w-7xl mx-auto space-y-5 sm:space-y-6 animate-in fade-in duration-500">
        ...
        {/* Top Control Bar */}
        <div className="flex flex-col lg:flex-row gap-3.5 items-stretch lg:items-center justify-between bg-[#090d16] border border-slate-800/60 p-3.5 sm:p-4 rounded-2xl shadow-lg">
          <div className="flex items-center justify-between lg:justify-start gap-4 shrink-0">
            <h1 className="text-lg sm:text-xl font-bold tracking-tight text-slate-200">
              Planner de Estudos
            </h1>
          </div>

          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 flex-1 justify-end w-full">
            ...
            <div className="grid grid-cols-2 sm:flex items-center gap-2 shrink-0 justify-end">
              ...
              >
                <Plus size={14} />
                <span className="truncate">Novo conteúdo</span>
              </button>
            </div>
          </div>
        </div>
        ...
        <section className="mt-4 sm:mt-6">
          <h2 className="text-xs font-bold text-slate-500 mb-2 sm:mb-3 uppercase tracking-wider">
            Pendentes de hoje
          </h2>
          <PendingSubjects
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 bg-linear-to-r from-[#090d16] via-[#0c1222] to-[#090d16] border border-white/10 p-3.5 sm:p-4 rounded-2xl shadow-xl">
          <div className="flex items-center gap-3">
            <div className="p-2 sm:p-2.5 rounded-xl bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 font-bold text-xs">
              {
                topics.filter(
          ...
          <div className="flex items-center gap-3 sm:border-x border-white/10 sm:px-4">
            <div className="p-2 sm:p-2.5 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 font-bold text-xs">
              {subjects.length}
            </div>
            <div>
              <p className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">
