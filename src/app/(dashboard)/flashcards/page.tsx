    ...
    <div className="p-4 md:p-8 max-w-7xl mx-auto text-slate-100 space-y-8 selection:bg-indigo-500/30 font-sans">
      ...
      {totalSubjects === 0 ? (
        <div className="min-h-[70vh] flex items-center justify-center py-4">
          <div className="relative overflow-hidden max-w-xl w-full bg-linear-to-b from-[#0c101d] via-[#080b14] to-[#04060c] border border-amber-500/30 rounded-3xl p-8 sm:p-12 text-center shadow-2xl space-y-6">
            ...
            <div className="space-y-2 relative z-10">
              ...
              <p className="text-slate-300 text-xs leading-relaxed max-w-sm mx-auto">
                ...
                baralhos de memorização espaçada, é necessário mapear o seu
                edital de concurso primeiro.
              </p>
            </div>
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
              <div className="space-y-3 max-w-2xl">
                ...
                <p className="text-slate-300 text-sm leading-relaxed">
                  ...
                  prontos para revisão hoje pelo algoritmo de repetição
                  espaçada.
                </p>
            ...
            <div className="p-6 bg-slate-900/40 border border-slate-800/80 rounded-2xl backdrop-blur-xl flex flex-col justify-between space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="text-xs font-bold text-emerald-400 flex items-center gap-1">
                  <TrendingUp size={12} /> Alta Precisão
                </span>
              </div>
            ...
            {recentDecks.length === 0 ? (
              <div className="p-12 text-center bg-slate-900/20 border border-dashed border-slate-800 rounded-2xl">
                ...
                <p className="text-slate-500 text-xs mb-4 max-w-sm mx-auto">
                  Crie seu primeiro conjunto de estudos para ativar o algoritmo
                  de repetição.
                </p>
                <Link
                  href="/flashcards/decks?openModal=true"
