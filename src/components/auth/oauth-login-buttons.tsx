  ...
  return (
    <div className="space-y-3.5">
      ...
      <button
        ...
        className="group relative w-full flex items-center justify-center gap-3.5 bg-white hover:bg-slate-50 text-slate-800 border border-slate-200 hover:border-slate-300 shadow-xs dark:bg-slate-900/80 dark:hover:bg-slate-800 dark:text-slate-100 dark:border-white/10 dark:hover:border-violet-500/40 font-bold py-3.5 px-4 rounded-2xl transition-all duration-200 cursor-pointer dark:shadow-lg active:scale-[0.98] text-sm overflow-hidden disabled:opacity-60"
      >
        ...
        {loadingProvider === "google" ? (
          <Loader2 className="w-4 h-4 text-violet-600 dark:text-violet-200 animate-spin shrink-0" />
        ) : (
        ...
        {!googleConfigured && (
          <span className="ml-auto rounded-md bg-amber-500/15 border border-amber-500/30 px-2 py-0.5 text-[10px] font-mono font-bold text-amber-600 dark:text-amber-300">
            Configurar
          </span>
        )}
      </button>
      ...
      >
        ...
        {loadingProvider === "github" ? (
          ...
          <svg
            className="w-4 h-4 fill-current text-slate-900 dark:text-white shrink-0"
            viewBox="0 0 24 24"
          >
      ...
      {isInIframe && (
        <div className="flex items-start gap-2 p-2.5 rounded-xl border border-indigo-200 bg-indigo-50/70 text-slate-700 dark:border-indigo-500/20 dark:bg-indigo-500/5 dark:text-slate-300 text-[11px] leading-relaxed">
          ...
          <span>
            ...
            <strong className="text-violet-700 dark:text-violet-300">Use o Modo Convidado acima para testar agora.</strong>
          </span>
        </div>
      )}
