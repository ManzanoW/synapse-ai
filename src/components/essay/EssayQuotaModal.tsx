      ...
      <AnimatePresence>
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 bg-black/80 backdrop-blur-md">
          ...
          <motion.div
            ...
            className="bg-white dark:bg-[#080c16] border border-slate-200 dark:border-violet-500/30 rounded-3xl p-6 sm:p-8 max-w-lg w-full relative overflow-hidden shadow-2xl shadow-violet-950/20 dark:shadow-violet-950/60 text-center space-y-6"
          >
            {/* Header Badge */}
            <div className="space-y-2 relative z-10">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-500/10 dark:bg-amber-500/15 border border-amber-500/25 dark:border-amber-500/30 text-amber-700 dark:text-amber-300 text-[11px] font-bold tracking-wider uppercase">
            ...
            <div className="p-3.5 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 dark:border-emerald-500/25 flex items-center gap-3 text-left">
            ...
            <div className="space-y-2.5 pt-1 relative z-10">
              ...
              {canWatchAd !== false ? (
                <button
                  ...
                  className="w-full py-3 px-4 bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 hover:from-amber-400 hover:to-orange-400 text-white font-black text-xs sm:text-sm rounded-xl shadow-lg shadow-amber-950/20 dark:shadow-amber-950/60 flex items-center justify-center gap-2 transition-all cursor-pointer group"
                >
                  <Gift size={16} className="text-white group-hover:scale-110 transition-transform" />
                  <span>🎬 Assistir Vídeo (+1 Correção Bônus)</span>
                </button>
              ) : (
                <div className="w-full py-2.5 px-4 bg-amber-500/10 border border-amber-500/25 text-amber-700 dark:text-amber-300 text-xs font-bold rounded-xl flex items-center justify-center gap-2 select-none">
              ...
              <Link
                href="/pricing"
                onClick={onClose}
                className="w-full py-3 px-4 bg-gradient-to-r from-violet-600 via-indigo-600 to-indigo-500 hover:from-violet-500 hover:to-indigo-400 text-white font-black text-xs sm:text-sm rounded-xl shadow-lg shadow-violet-950/20 dark:shadow-violet-950/60 flex items-center justify-center gap-2 transition-all cursor-pointer group"
              >
              ...
              <button
                type="button"
                onClick={onClose}
                className="w-full py-2.5 px-4 bg-slate-100 hover:bg-slate-200 text-slate-700 hover:text-slate-900 dark:bg-slate-900 dark:hover:bg-slate-800 dark:text-slate-300 dark:hover:text-white text-xs font-bold rounded-xl border border-slate-200 dark:border-slate-800 transition-all cursor-pointer mt-1"
              >
