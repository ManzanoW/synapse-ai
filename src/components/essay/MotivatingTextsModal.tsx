      ...
      <div className="bg-slate-900 border border-violet-500/30 rounded-2xl w-full max-w-3xl lg:max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl flex flex-col">
        ...
        <div className="p-4 sm:p-6 flex flex-col gap-4">
          ...
          {theme.expectedTopics && theme.expectedTopics.length > 0 && (
            <div className="bg-indigo-950/30 border border-indigo-500/20 rounded-xl p-4 flex flex-col gap-2">
          ...
          {theme.instructions && theme.instructions.length > 0 && (
            <div className="bg-slate-800/30 border border-white/5 rounded-xl p-3 text-[11px] text-slate-400">
