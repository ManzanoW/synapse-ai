            ...
            {isOpen && (
              <>
                ...
                <motion.div
                  ...
                  className="fixed z-50 inset-x-3 top-16 max-w-sm mx-auto md:inset-auto md:left-[268px] md:top-14 md:w-96 md:max-w-sm bg-[#060913]/95 border border-slate-800/90 rounded-2xl shadow-2xl backdrop-blur-2xl overflow-hidden flex flex-col max-h-[82vh] md:max-h-[520px]"
                >
                  {/* Cabeçalho */}
                  ...
                  <div className="flex-1 overflow-y-auto divide-y divide-slate-800/50 p-2 space-y-1 scrollbar-thin scrollbar-thumb-slate-800">
                    {isLoading ? (
                  ...
                  {/* Rodapé Informativo */}
                  <div className="px-4 py-2 border-t border-slate-800/60 bg-slate-950/60 flex items-center justify-between text-[10px] text-slate-500 shrink-0">
