...
const STATIC_PAGES: Omit<PaletteItem, "id">[] = [
  {
    title: "Dashboard",
    subtitle: "Visão geral da jornada, XP, ofensiva e estatísticas",
    icon: LayoutDashboard,
    iconColor: "text-indigo-400",
    iconBg: "bg-indigo-500/10 border-indigo-500/20",
    category: "Páginas",
    href: "/dashboard",
    keywords: ["home", "inicio", "xp", "streak", "painel", "resumo"],
  },
  {
    title: "Edital Verticalizado",
    subtitle: "Acompanhamento detalhado de matérias, tópicos e SM-2",
    icon: FileSpreadsheet,
    iconColor: "text-cyan-400",
    iconBg: "bg-cyan-500/10 border-cyan-500/20",
    category: "Páginas",
    href: "/edital",
    keywords: ["conteudos", "materias", "topicos", "disciplinas", "concurso", "edital"],
  },
  {
    title: "Cronograma Semanal",
    subtitle: "Ciclos de estudo, metas semanais e balanceamento adaptativo",
    icon: Sparkles,
    iconColor: "text-amber-400",
    iconBg: "bg-amber-500/10 border-amber-500/20",
    category: "Páginas",
    href: "/week",
    keywords: ["semana", "remanejamento", "planejamento", "agenda", "dias", "ciclo", "sos"],
  },
  {
    title: "Banco de Provas & Questões",
    subtitle: "Simulados por banca examinadora e questões geradas por IA",
    icon: FileStack,
    iconColor: "text-emerald-400",
    iconBg: "bg-emerald-500/10 border-emerald-500/20",
    category: "Páginas",
    href: "/questions",
    keywords: ["simulado", "quiz", "exercicios", "gabarito", "cebraspe", "fgv", "vunesp", "provas"],
  },
  {
    title: "Redação Oficial (Discursivas)",
    subtitle: "Correção de redação estilo CEBRASPE com IA e Nota 100",
    icon: PenTool,
    ...
    category: "Páginas",
    href: "/redacao",
    keywords: ["redacao", "discursiva", "cebraspe", "texto", "criterios", "nota 100", "dissertativa", "folha"],
  },
  {
    title: "Caderno de Erros Inteligente",
    subtitle: "Diagnóstico neural de erros, motivos e plano de superação",
    icon: BookOpenCheck,
    ...
    category: "Páginas",
    href: "/notebook",
    keywords: ["caderno de erros", "erros", "pegadinhas", "revisao de erros", "gaps", "falhas"],
  },
  {
    title: "Sala de Foco & Pomodoro",
    subtitle: "Ambiente imersivo com ruído branco, ondas alfa e timer",
    icon: Headphones,
    ...
    category: "Páginas",
    href: "/study-room",
    keywords: ["foco", "pomodoro", "timer", "musica", "binaural", "lofi", "ondas alfa", "sala de estudo"],
  },
  {
    title: "Cards & Flashcards",
    subtitle: "Prática com repetição espaçada ativa (algoritmo FSRS/SM-2)",
    icon: Layers,
    iconColor: "text-purple-400",
    iconBg: "bg-purple-500/10 border-purple-500/20",
    category: "Páginas",
    href: "/flashcards",
    keywords: ["cards", "anki", "memorizacao", "baralhos", "revisao", "flashcards", "podcast", "speed run"],
  },
  {
    title: "Analytics & Performance",
    subtitle: "Métricas de retenção, precisão e gráficos de evolução",
    icon: TrendingUp,
    iconColor: "text-blue-400",
    iconBg: "bg-blue-500/10 border-blue-500/20",
    category: "Páginas",
    href: "/performance",
    keywords: ["graficos", "estatisticas", "desempenho", "taxa", "tempo", "analytics", "horas"],
  },
  {
    title: "Hall de Conquistas & XP",
    subtitle: "Badges desbloqueadas, patentes, prestígio e recompensas",
    icon: Trophy,
    ...
    category: "Páginas",
    href: "/achievements",
    keywords: ["medalhas", "badges", "niveis", "recompensas", "gamificacao", "trofeus", "prestigio"],
  },
  {
    title: "Calendário de Revisões",
    subtitle: "Linha do tempo e datas previstas pelo algoritmo SM-2",
    icon: CalendarDays,
    iconColor: "text-sky-400",
    iconBg: "bg-sky-500/10 border-sky-500/20",
    category: "Páginas",
    href: "/calendar",
    keywords: ["datas", "mes", "agenda", "agendamento", "calendario", "cronograma"],
  },
  {
    title: "Meu Perfil",
    subtitle: "Configurações de conta, metas de estudo e dados pessoais",
    icon: UserCircle2,
    iconColor: "text-slate-300",
    iconBg: "bg-slate-800/60 border-slate-700/60",
    category: "Páginas",
    href: "/profile",
    keywords: ["usuario", "configuracoes", "senha", "dados", "email", "perfil", "conta"],
  },
  {
    title: "Central de Ajuda & Suporte",
    subtitle: "Guia de uso da plataforma, dúvidas frequentes e contato",
    icon: HelpCircle,
    iconColor: "text-slate-400",
    iconBg: "bg-slate-800/60 border-slate-700/60",
    category: "Páginas",
    href: "/help",
    keywords: ["ajuda", "faq", "duvidas", "suporte", "tutorial", "como funciona"],
  },
];
...
const STATIC_ACTIONS: Omit<PaletteItem, "id">[] = [
  {
    ...
    href: "/questions",
    keywords: ["gerar", "novo simulado", "quiz", "inteligencia artificial", "questoes"],
  },
  {
    title: "Corrigir Redação com IA",
    subtitle: "Submeter texto dissertativo para avaliação com espelho CEBRASPE",
    icon: PenTool,
    iconColor: "text-pink-400",
    ...
    category: "Ações Rápidas",
    href: "/redacao",
    keywords: ["corrigir redacao", "discursiva", "cebraspe", "avaliar redacao", "nota 100", "texto"],
  },
  {
    title: "Iniciar Sessão de Foco Pomodoro",
    subtitle: "Entrar na Sala de Foco com timer de 25 minutos e som imersivo",
    icon: Headphones,
    iconColor: "text-teal-400",
    ...
    category: "Ações Rápidas",
    href: "/study-room",
    keywords: ["iniciar foco", "pomodoro", "timer", "concentracao", "estudar agora", "som"],
  },
  {
    title: "Importar ou Estruturar Edital",
    subtitle: "Carregar matérias e tópicos via texto ou arquivo PDF",
    icon: FileSpreadsheet,
    iconColor: "text-cyan-400",
  ...
  {
    title: "Praticar Questões no Caderno de Erros",
    subtitle: "Diagnosticar e refazer questões que você errou anteriormente",
    icon: BookOpenCheck,
    iconColor: "text-rose-400",
    iconBg: "bg-rose-500/10 border-rose-500/30",
    badge: "IA",
    ...
    category: "Ações Rápidas",
    href: "/notebook",
    keywords: ["caderno de erros", "refazer erros", "questoes erradas", "gaps"],
  },
  {
  ...
  {
    title: "Ver Mapas Mentais do Edital",
    subtitle: "Abrir resumos estruturados neurais em formato visual",
    icon: Brain,
    iconColor: "text-indigo-400",
    ...
    category: "Ações Rápidas",
    href: "/edital",
    keywords: ["mapa mental", "mindmap", "resumo visual", "esquema"],
  },
];
